...
- ladders, vines and scaffolding: the fall clamp, climbing on jump or while pushing into the wall, descending on sneak; from
  ...
  to cross into a cell without scaffolding stopped it)
...
| climbing, both clients | 8 and 1 | sneaking down scaffolding, and a landing between scenarios |
...
registers on both clients: 71 recordings, 245,600 ticks, 99.7% of them replayed exactly (244,928 of 245,555). Knockback, push, teleport, ice, soul sand, sneak edges, poses, epsilon moves, multi-system cases,
